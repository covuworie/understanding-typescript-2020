...
interface ErrorContainer {  // e.g. { email: 'Not a valid email, username: 'Must start with a character!' }
    // index properties:
    // gives us flexibility as we don't need to know in advance the names of the properties and how many we will need
    [prop: string]: string;
}
