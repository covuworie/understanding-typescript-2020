import { autobind as Autobind } from "../decorators/autobind.js"; // dealing with nameclashes
import { projectStateManager } from "../state/project.js";
import * as Validation from "../util/validation.js"; // doesn't seem like a good practise
import Cmp from "./base-component.js"; // Cmp can be any name and imports the "default" export from the file
